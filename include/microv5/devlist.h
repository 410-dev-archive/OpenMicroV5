...
pros::Motor ALL_WHEELS[] = {WHEEL_FRONT_LEFT, WHEEL_FRONT_RIGHT, WHEEL_BACK_LEFT, WHEEL_BACK_RIGHT};

pros::Motor ALL_MOTORS[] = {
  WHEEL_FRONT_LEFT, WHEEL_FRONT_RIGHT, WHEEL_BACK_LEFT, WHEEL_BACK_RIGHT,
  MOTOR_FRONTARM_LEFT, MOTOR_FRONTARM_RIGHT,
  MOTOR_PULLER_LEFT, MOTOR_PULLER_RIGHT
};
